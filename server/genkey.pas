...
uses
  ...
  PassphraseRequestForm, ImportKeyForm;
...
type
  TfrmKeys = class(TForm)
    ...
    Revoke1: TMenuItem;
    tlb1: TToolBar;
    btnNewKeyring: TToolButton;
    btnDelim1: TToolButton;
    btnOpenKeyring: TToolButton;
    btnSaveKeyring: TToolButton;
    btnDelim2: TToolButton;
    btnGenerateKey: TToolButton;
    btnDelim3: TToolButton;
    btnAddKey: TToolButton;
    btnRemoveKey: TToolButton;
    btnExportKey: TToolButton;
    btnDelim4: TToolButton;
    btnSign: TToolButton;
    btnRevoke: TToolButton;
